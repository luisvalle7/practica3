...
Un evento es una accion que se ejecuta al momento de que el usuario interactue con la aplicacion de alguna forma como un click. React escucha el evento mediante atributos como onClick{} y reponde con una accion.
